...
/**
 * Donuts are .75 each or 8.00 per dozen. Coffees are 1.50 each, but you get two
 * free coffees for each dozen donuts.
 * 
...
public class Donuts {
	 ...
	 * 
	 * @param donuts  number of donuts
	 * @param coffees number of coffees
	 * @return cost for a given number of donuts and coffees
	 */
